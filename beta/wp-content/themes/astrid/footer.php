		...
		<footer id="colophon" class="site-footer" role="contentinfo">	
			<div class="site-info container">
				...
				<div class="site-copyright">
					...
					2017 &copy; Frioland Corp. All Rights Reserved.<br />
					Development and Design by <a style="text-decoration: underline" href="http://absorbingdesign.com">Absorbing Design</a>
				</div>
			</div><!-- .site-info -->
		</footer><!-- #colophon -->
	</div>
